...
const PLATFORM_MENU = [
  {
    key: 'playground',
    label: 'Playground',
    children: ['Historico', 'Favoritos', 'Configuracoes'],
  },
  {
    key: 'documentos',
    label: 'Documentos',
    children: ['Vigentes', 'Em revisao', 'Obsoletos'],
  },
      ...
      return (
        <div key={item.key}>
          <button
            ...
            className={`flex w-full items-center rounded-lg px-2.5 py-2 text-sm font-medium text-slate-300 transition hover:bg-slate-800/80 hover:text-white ${
        ...
        >
          ...
          <div className="mt-6 space-y-6">
            <div>
              ...
              <nav className="space-y-1">{renderMenu(PLATFORM_MENU)}</nav>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className={`text-sm ${palette.textSecondary}`}>
                    Painel inicial da plataforma de gestao documental.
                  </p>
                </div>
              </div>
